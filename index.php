...
<head>
    ...
    <script>
        ...
        grunticon(["assets/images/svg/output/icons-data-svg.css", "assets/images/svg/output/icons-data-png.css", "assets/images/svg/output/icons.fallback.css"] , grunticon.svgLoadedCallback);
    </script>
