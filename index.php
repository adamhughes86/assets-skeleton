...
<head>
    ...
    <link rel="icon" type="image/png" href="/assets/images/faviconsfavicon-96x96.png" sizes="96x96" />
    ...
    <script>
        ...
        grunticon(["assets/images/svg/output/icons-data-svg.scss", "assets/images/svg/output/icons-data-png.css", "assets/images/svg/output/icons.fallback.css"] , grunticon.svgLoadedCallback);
    </script>
...
<header class="header">
    <nav class="main-nav">
        <a class="main-nav__item" href="#">Link 1</a>
        <a class="main-nav__item" href="#">Link 2</a>
        <a class="main-nav__item" href="#">Link 3</a>
        <a class="main-nav__item" href="#">Link 4</a>
        <button class="main-nav__item js-nav-more">More links</button>

        <div class="main-nav__sub js-sub-nav">
            <a class="main-nav__sub-item" href="#">Sub Link 1</a>
            <a class="main-nav__sub-item" href="#">Sub Link 2</a>
            <a class="main-nav__sub-item" href="#">Sub Link 3</a>
            <a class="main-nav__sub-item" href="#">Sub Link 4</a>
        </div>
    </nav>
</header>
